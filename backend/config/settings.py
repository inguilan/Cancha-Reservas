...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "cancha_db"),
        "USER": os.getenv("POSTGRES_USER", "cancha_user"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "cancha_password"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@cancha.local")
